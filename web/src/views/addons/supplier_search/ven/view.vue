          ...
          <n-space>
            ...
            >
              <n-form-item label="品牌：" path="brand">
                <n-input
                  v-model:value="formParam.brand"
                  clearable
                  placeholder=""
                  v-bind:on-clear="formQuery"
                  @keyup.enter="formQuery"
                />
              </n-form-item>
              <n-form-item label="条码：" path="barcode">
                <n-input
                  v-model:value="formParam.barcode"
                  clearable
                  placeholder=""
                  v-bind:on-clear="formQuery"
                  @keyup.enter="formQuery"
              ...
              <n-form-item label="供应商：" path="vendor">
                <n-input
                  v-model:value="formParam.vendor"
                  clearable
                  placeholder=""
                  v-bind:on-clear="formQuery"
                  @keyup.enter="formQuery"
            ...
            <n-table :bordered="false" :single-line="false" size="small">
              ...
              <tbody>
                <tr v-for="(item, i) in detailList">
                  ...
                  <td v-bind:title="'汇率时间：' + item.exchangeRateTime"
                    >{{ item.exchangeRate }}
                  </td>
