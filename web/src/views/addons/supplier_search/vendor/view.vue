  ...
  <div>
    ...
    <n-card :bordered="false" class="proCard mt-4" size="small" :segmented="{ content: true }">
      <n-descriptions label-placement="left" class="py-2" column="4">
        ...
        <n-descriptions-item>
          <template #label>完整字段，多个用英文逗号隔开</template>
          <span v-html="formValue.allColumn"></span></n-descriptions-item>

        <n-descriptions-item>
          <template #label>隐藏字段，多个用英文逗号隔开</template>
          <span v-html="formValue.requiredColumn"></span></n-descriptions-item>
...
<script lang="ts" setup>
  ...
  import { View } from '@/api/addons/supplier_search/vendor';
